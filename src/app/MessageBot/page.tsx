  ...
  return (
    <div className="flex flex-col mt-5 gap-4 w-full max-w-lg mx-auto p-6 bg-white text-black rounded-2xl shadow-md px-5 sm:px-10">
      ...
      <div className="flex justify-center gap-3">
        <button
          className={`px-4 py-2 rounded-lg text-white transition-all duration-150 hover:scale-105 ${
            msgType === "normal" ? "bg-[#3232ba]" : "bg-gray-500"
          }`}
        ...
        <button
          className={`px-4 py-2 rounded-lg text-white transition-all duration-150 hover:scale-105 ${
            msgType === "unknown" ? "bg-[#3232ba]" : "bg-gray-500"
          }`}
      ...
      <div className="flex flex-col gap-3">
        ...
        <button
          onClick={sendMessage}
          disabled={loading}
          className={`w-full mt-3 py-3 text-white rounded-xl text-lg font-medium transition-all shadow-sm ${
            loading
